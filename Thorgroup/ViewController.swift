...
class ViewController: VGBaseController {
    ...
    override func viewDidAppear(_ animated: Bool) {
     super.viewDidAppear(animated)
        ...
        self.popImgView.kf.setImage(with: URL(string:"https://images.voghion.com/productImages/90d3daf83cd24329b516d511f8d6bd89.png"))
//        popImgView.image = UIColor.hexImage(0x00FF00, 0.5)
    }
