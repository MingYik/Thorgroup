...
class VGPageVC: VGBaseController {
...
//        button.backgroundColor = hx_backgroundColor
    ...
    lazy var barTintBtn: UIButton = {
        ...
        button.setTitleColor(.lightGray, for: .normal)
//        button.backgroundColor = hx_tintColor
    ...
    lazy var barTitleBtn: UIButton = {
        ...
        button.setTitleColor(.lightGray, for: .normal)
//        button.backgroundColor = hx_titleColor
    ...
    @objc func barImageSwitchChanged(_ sender: UISwitch) {
        FHBlueTooth.helloWorld()

    }
    
    @objc func blackBarStyleSwitchChanged(_ sender: UISwitch) {
        let input:[UInt8] = [0xAA, 0x00, 0x00 ,0x00]
        let bytes:[UInt8] = FHBlueTooth.blueGetCRC(input)
        print(bytes)
    }
    
    @objc func shadowHiddenSwitchChanged(_ sender: UISwitch) {
        FHBlueTooth.blueSearch()
